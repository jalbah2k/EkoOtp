...
public partial class AddHtml5Video : OboutInc.oboutAJAXPage
{
    ...
    void Page_Load(object sender, EventArgs e)
    {
        ...
        Uploader1.TempDirectory = "~/Policies/Images/";
    }
    ...
    {
        ViewState["dirID"] = hfPath.Value;
        File.Delete(Server.MapPath(txtPath.Text));
        //Response.Write(Server.MapPath(txtPath.Text));
        LoadGrid();
    }
    ...
    {
        ViewState["dirID"] = hfPath.Value;
        string snewdir = Server.MapPath(hfPath.Value + "/" + txtNewFolder.Text);
