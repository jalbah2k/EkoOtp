...
public partial class Controls_PopupMessagesManager_PopupMessagesManager : System.Web.UI.UserControl
{
    #region Properties
    ...
    public Controls_PopupMessagesManager_PopupMessagesManager()
    {
    }

    public Controls_PopupMessagesManager_PopupMessagesManager(string par)
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            /*if (Session["LoggedInID"] != null)
            {
                ...
                {*/
                    btnPopupMessagesAdd.Visible = true;
                /*}
            }*/
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        using (SqlConnection sqlConn = new SqlConnection(ConfigurationManager.AppSettings["CMServer"]))
        {
            ...
            {
                strcmd = " declare @PMId int declare @ContentId int declare @Zone_ID int ";
                strcmd += " insert into PopupMessages(name, html, lang) values(@name, @html, @lang) ";
                strcmd += " select @PMId = @@IDENTITY ";
                strcmd += " insert into content(name, control, param, language) values('PopupMessages - ' + @name, 'popupmessages', @PMId, @lang) ";
