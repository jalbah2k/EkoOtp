...
public partial class controls_AZ_az : System.Web.UI.UserControl
{
    ...
    {
        SqlDataAdapter dapt = new SqlDataAdapter("AZPgetall", ConfigurationManager.AppSettings["CMServer"]);
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            temp.Text = "<div class=\"header\" style=\"text-transform:uppercase;padding-top:20px;position:relative;left:-50px;\"><a id=\"az" + dr["letter"].ToString().ToLower() + "\">";
