...
public partial class controls_AZ_az : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            temp.Text = "<div class=\"header\" style=\"text-transform:uppercase;padding-top:20px;left:-50px;position:relative;\"><a id=\"az" + dr["letter"].ToString().ToLower() + "\">";
            pnlAZ.Controls.Add(temp);
            temp = new Literal();
            temp.Text = "<img src=\"/images/cheo2/atoz/" + dr["letter"].ToString() + ".jpg\" border=\"0\" />";
            pnlAZ.Controls.Add(temp);
            temp = new Literal();
            temp.Text = "</a></div>";
            pnlAZ.Controls.Add(temp);
            ...
            foreach (string s in cats)
            {
                ...
                {
                    temp = new Literal();
                    temp.Text = "<div class=\"title\" style=\"padding-top:10px;padding-bottom:5px;padding-left:15px;\">";
                    pnlAZ.Controls.Add(temp);
                    temp = new Literal();
                    temp.Text = s;
                    pnlAZ.Controls.Add(temp);
                    ...
                    foreach (DataRow dr2 in ds.Tables[2].Rows)
                    {
                        ...
                        {
                            temp = new Literal();
                            temp.Text = "<div style=\"padding-left:30px;\"><a href=\"" + dr2["url"].ToString() + "><span style=\"font-family:arial;font-size:12px;color:#2790d4;text-decoration:none;\">" + dr2["name"].ToString() + "aaaaaaaa</span></a></div>";
                            pnlAZ.Controls.Add(temp);
                        }
                    }
