...
function ada_Switch(MenuID,elem)
	{
		//var menu = document.getElementById(MenuID);
		//menu.SelectedMenuItem = elem.id;
		var submenu = document.getElementById(elem.id+'-subMenu');
		var exp = document.getElementById(MenuID+'_expanded');
		if (submenu!=null){  //if submenu exists 
...
function ada_Expand(menuID)
	{
		var exp = document.getElementById(menuID+'_expanded');
		if (exp!=null)
		{
			var submenu = document.getElementById(exp.value+'-subMenu');
			if (submenu!=null)	
			{
				submenu.style.display='block';
			}
