...
public class MyDAL_Resources
{
    public MyDAL_Resources() { }

    private static string _connection = System.Configuration.ConfigurationManager.AppSettings.Get("dbResources");
