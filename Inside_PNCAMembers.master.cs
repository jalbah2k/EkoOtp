...
public partial class Inside_PNCAMembers : System.Web.UI.MasterPage
{
    ...
    {
        {
            ...
            if(InsideClass == "yes-inside-menu")
                script.Append(Environment.NewLine + String.Format("$(body).addClass(\"{0}\");", "insideMainTemplate") + Environment.NewLine);
