<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WidgetImage.ascx.cs" Inherits="WidgetImage" %>
			...
			<asp:Panel ID="pnlEditGrp" runat="server" Visible="false">
                <div class="admin-white-box">
                    <div class="admin-white-box-inner">
                        ...
                        <tr><td class="admin-prompt-right">Link</td><td><asp:TextBox ID="txtLinkGrp" runat="server" CssClass="textbox" Width="450" />
                            </td></tr>
                        </table>
                    </div>
                </div>
                ...
                function BindControlEvents() {
                    $('#<%= GV_Images.ClientID %>').tableDnD(
                    {
                        ...
                        onDrop: function (table, row) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "admin.aspx/WidgetImages_Reorders",
                ...
                <div class="admin-white-box">
                    <div class="admin-white-box-inner">
                        <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr><td class="admin-prompt-right">Name</td><td><asp:TextBox ID="txtName" runat="server" CssClass="textbox" Width="450" /></td></tr>
                            <tr><td class="admin-prompt-right">Title</td><td><asp:TextBox ID="txtTitle" runat="server" CssClass="textbox" Width="450" /></td></tr>
